...
import cn.cyyaw.config.table.table.entity.CInterface;
import cn.cyyaw.config.table.table.entityconst.CInterfaceConst;
...
public class CInterfaceController {
     ...
     */
    @GetMapping(value = "/findAllCInterface")
     ...
     * 分页条件查询
     */
    @GetMapping(value = "/findPageCInterface")
     ...
     * 根据ID查询
     */
    @GetMapping(value = "/findIdCInterface")
    ...
    public void saveCInterface(HttpServletResponse response,@RequestBody CInterface cInterface) {
        ...
        if (null == id) {
            ...
            cInterface.setCreatetime(new Date());
     ...
     * 删除
     */
    @PostMapping(value = "/delCInterface")
