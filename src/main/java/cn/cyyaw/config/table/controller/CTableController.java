...
import cn.cyyaw.config.table.table.entityconst.CTableConst;
...
public class CTableController {
     ...
     * 表:c_table ===> 所有:带条件
     */
    @GetMapping(value = "/findAllCTable")
     ...
     * 分页条件查询
     */
    @GetMapping(value = "/findPageCTable")
