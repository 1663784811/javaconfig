...
import cn.cyyaw.config.table.table.entityconst.CPageComponentsConst;
...
public class CPageComponentsController {
     ...
     */
    @GetMapping(value = "/findAllCPageComponents")
     ...
     * 分页条件查询
     */
    @GetMapping(value = "/findPageCPageComponents")
     ...
     * 根据ID查询
     */
    @GetMapping(value = "/findIdCPageComponents")
     ...
     * 删除
     */
    @PostMapping(value = "/delCPageComponents")
